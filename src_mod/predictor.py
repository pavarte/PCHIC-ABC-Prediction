...
def add_hic_to_enh_gene_table(enh, genes, pred, hic_file, hic_norm_file, hic_is_vc, chromosome, args):
    ...
    if args.hic_type == "bedpe":
        ...
        print('hic head ',hic1.head())
        print('hic1 shape == ',hic1.df.shape)
        ...
        #print('enh_hic1_shape == ',enh_hic1.shape)
        #enh_hic1.to_csv('enh_hic1.csv',sep = '\t')
        #print('genes hic2 head == ',genes_hic2.head())
